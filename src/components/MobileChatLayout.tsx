...
import { SidebarOption } from '@/types/options'
													...
													<ul role='list' className='flex flex-1 flex-col gap-y-7'>
														...
														<li>
															...
															<ul role='list' className='-mx-2 mt-2 space-y-1'>
																...
																<li>
																	<SentRequestsSidebarOption initialSentRequestCount={sentRequestCount} sessionId={session.user.id} />
																</li>
															</ul>
														</li>

														<li className='-ml-6 mt-auto flex items-center absolute bottom-0 w-full'>
