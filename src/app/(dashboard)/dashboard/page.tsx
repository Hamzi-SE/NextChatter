import { getLatestChatMessage } from '@/helpers/get-chat-messages'
						...
						<Link href={`/dashboard/chat/${chatHrefConstructor(session.user.id, friend.id)}`} className='relative sm:flex'>
							<div className='mb-4 flex-shrink-0 sm:mb-0 sm:mr-4'>
								<div className='relative h-6 w-6'>
									<Image src={friend.image} fill className='rounded-full' alt={`${friend.name} profile picture`} referrerPolicy='no-referrer' />
								</div>
							</div>
